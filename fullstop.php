<?php
    ...
    if (!@mysql_select_db('full-stop')) {   include("./assets/codes/db.html"); die(); }
    ...
    $query = mysql_query("INSERT INTO events (`count`,`type`,`request`,`referrer`,`agent`,`date`,`time`) VALUES('1', '$errorType', '$req', '$ref', '$agent', '$date', '$time')");
